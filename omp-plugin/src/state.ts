...
export type SessionState = {
  ...
  pendingAttachmentConfirmableTaskId: string | null;
...
export function createSessionState(): SessionState {
  return {
    ...
    pendingAttachmentConfirmableTaskId: null,
    validatedTaskIds: new Set(),
    currentTurn: null,
  };
}
...
export function startTurn(state: SessionState, messageID?: string, startedAt: Date = new Date()): TurnState {
  ...
  const pendingAttachmentConfirmable = state.pendingAttachmentConfirmableTaskId === pendingTaskId;
  ...
  const turn: TurnState = {
    ...
    pendingAttachment: pendingTaskId
      ? {
          ...
          confirmable: pendingAttachmentConfirmable,
          enqueued: false,
        }
      : null,
  };
